...
This document provides comprehensive guidance for using the Azure Container Registry (ACR) with the Shift Agent application.

## 🏗️ Overview

The Azure Container Registry stores and manages Docker container images for the Shift Agent application. It provides:
