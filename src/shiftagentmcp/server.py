...
mcp: FastMCP = FastMCP("shiftagent-mcp", dependencies=["httpx"])
...
def main():
    ...
    if transport == "http":
        ...
        # SSE transport configuration (deprecated, but supported for legacy clients)
        host = os.getenv("MCP_SSE_HOST", "127.0.0.1")
        port = int(os.getenv("MCP_SSE_PORT", "8084"))
