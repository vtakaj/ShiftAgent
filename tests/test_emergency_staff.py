...
def test_add_employee_to_completed_job_logic_only():
    ...
    from shiftagent.api.jobs import job_lock, jobs
    from shiftagent.core.models import Employee, ShiftSchedule
...
def test_add_employee_to_invalid_job():
    ...
    from shiftagent.api.jobs import (
...
def test_add_employee_to_nonexistent_job():
    ...
    from shiftagent.api.jobs import add_employee_to_completed_job
    from shiftagent.core.models import Employee
