...
from shift_agent.api.converters import (
    convert_domain_to_response,
    convert_request_to_domain,
)
from shift_agent.api.schemas import (
    EmployeeRequest,
    ShiftRequest,
    ShiftScheduleRequest,
)
from shift_agent.core.models import Employee
...
def test_demo_data_with_preferences():
    ...
    from shift_agent.utils.demo_data import create_demo_schedule
