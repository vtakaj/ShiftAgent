...
class TestFilterShiftsByScope:
    ...
    def test_filter_by_date_range(self):
        ...
        scope = OptimizationScope(
            date_range=DateRange(
                start_date=datetime(2025, 6, 10), end_date=datetime(2025, 6, 16, 23, 59)
            )
        )
    ...
    def test_filter_by_location(self):
        ...
        scope = OptimizationScope(locations=["Hospital"])
    ...
    def test_filter_by_employees(self):
        ...
        scope = OptimizationScope(employees=["emp1", "emp2"])
    ...
    def test_filter_combined_criteria(self):
        ...
        scope = OptimizationScope(
            date_range=DateRange(
                start_date=datetime(2025, 6, 10), end_date=datetime(2025, 6, 12, 23, 59)
            ),
            locations=["Hospital"],
        )
