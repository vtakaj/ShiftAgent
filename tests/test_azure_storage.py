...
from src.natural_shift_planner.api.azure_job_store import AzureBlobJobStore
from src.natural_shift_planner.core.models.employee import Employee
from src.natural_shift_planner.core.models.shift import Shift
from src.natural_shift_planner.core.models.schedule import ShiftSchedule
...
class TestAzureBlobJobStore:
    ...
    def mock_blob_service_client(self):
        ...
        with patch('src.natural_shift_planner.api.azure_job_store.BlobServiceClient') as mock_client:
            mock_instance = Mock()
    ...
    def test_initialization_with_account_name(self, mock_blob_service_client):
        ...
        with patch('src.natural_shift_planner.api.azure_job_store.DefaultAzureCredential'):
    ...
    def test_save_and_get_job(self, job_store, mock_blob_service_client):
        ...
        mock_blob_data = Mock()
        mock_blob_data.readall.return_value = b'{"job_id": "test-job-1", "status": "completed"}'
...
def test_create_azure_job_store():
    ...
    from src.natural_shift_planner.api.azure_job_store import create_azure_job_store
    ...
    with patch.dict(os.environ, {
        ...
        with patch('src.natural_shift_planner.api.azure_job_store.BlobServiceClient'):
            store = create_azure_job_store()
    ...
    with patch.dict(os.environ, {
        ...
        with patch('src.natural_shift_planner.api.azure_job_store.BlobServiceClient'), \
             patch('src.natural_shift_planner.api.azure_job_store.DefaultAzureCredential'):
            store = create_azure_job_store()
            assert store is not None
            assert store.container_name == "job-data"