...
def main():
    ...
    # Check environment
    if not os.getenv("AZURE_STORAGE_CONNECTION_STRING") and not os.getenv("AZURE_STORAGE_ACCOUNT_NAME"):
        print("❌ No Azure Storage configuration found")
        print("   Set AZURE_STORAGE_CONNECTION_STRING or AZURE_STORAGE_ACCOUNT_NAME")
        print("   Example:")
        print("   export AZURE_STORAGE_CONNECTION_STRING='DefaultEndpointsProtocol=https;AccountName=...;AccountKey=...;EndpointSuffix=core.windows.net'")
        print("   or")
